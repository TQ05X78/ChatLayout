...
public abstract class SwipeToDeleteCallback extends ItemTouchHelper.Callback {
   ...
   SwipeToDeleteCallback(int i, int i1, Context context){
       mContext = context;
       mBackground = new ColorDrawable();
       backgroundColor = Color.parseColor("#b5b80a");
       mClearPaint = new Paint();
       mClearPaint.setXfermode(new
    ...
    private void clearCanvas(Canvas c, float v, float top, float right, float bottom) {
          ...
          c.drawRect(v,top, right, bottom, mClearPaint);
